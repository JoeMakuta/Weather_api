  ...
  return (
    <div className="w-[65%] flex flex-col justify-around h-full bg-black bg-opacity-30 p-20 ">
      <div className="flex gap-[3%]">
        <h1 className=" text-[10rem] transition-all ">
          {" "}
          {Math.round(
            weather_data &&
              weather_data.list[0] &&
        ...
        <div className="flex flex-col justify-center">
          <h1 className="font-bold text-4xl">
            {weather_data && weather_data.city && weather_data.city.name}
          </h1>
          <p>
            {weather_data &&
              weather_data.list[0] &&
            ...
            weather_data.list.map((weather, index) => {
              if (index !== 0) {
                ...
                return (
                  <div
                    key={index}
                    className=" flex flex-col items-center text-center w-20 justify-center rounded-lg h-32 "
                  >
